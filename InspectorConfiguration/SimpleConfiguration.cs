...
namespace ConfigurationManager
{
	...
	public class SimpleConfiguration : Configuration
	{
		...
		{
			return SimpleConfiguration.SaveConfiguration(typeof(SimpleConfiguration),instance, types);
		}
		...
		{
			return (SimpleConfiguration)SimpleConfiguration.LoadConfiguration(typeof(SimpleConfiguration), section, types);
		}
		#endregion
	}
}
