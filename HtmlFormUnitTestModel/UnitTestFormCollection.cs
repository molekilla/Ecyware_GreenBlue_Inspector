...
namespace Ecyware.GreenBlue.WebUnitTestManager
{
	...
	[Serializable]
	public class UnitTestFormCollection : IDictionary, ICloneable
	{
		/// <summary>
		...
		#region Constructors
		/// <summary>
		///		Initializes a new instance of the <see cref="UnitTestFormCollection"/> class that is empty, 
		///		has the default initial capacity and is sorted according to the <see cref="IComparable"/> interface 
		///		implemented by each key added to the <b>UnitTestFormCollection</b>.
		/// </summary>
		public UnitTestFormCollection()
		{
			keys = new string[DEFAULT_CAPACITY];
			values = new UnitTestItem[DEFAULT_CAPACITY];
		...
		///		interface implemented by each key added to the <b>UnitTestFormCollection</b>.
		/// </summary>
		/// <param name="capacity">The initial number of elements that the <see cref="UnitTestFormCollection"/> can contain.</param>
		/// <exception cref="ArgumentOutOfRangeException"><paramref name="capacity"/> is less than zero.</exception>
		public UnitTestFormCollection(int capacity)
		{
			if (capacity < 0)
				throw new ArgumentOutOfRangeException("capacity", capacity, "Initial capacity cannot be less than zero.");

			keys = new string[capacity];
			values = new UnitTestItem[capacity];
			comparer = Comparer.Default;
		}
		...
		/// </param>
		public UnitTestFormCollection(IComparer comparer) : this()
		{
			if (comparer != null)
		...
		/// <param name="capacity">The initial number of elements that the <see cref="UnitTestFormCollection"/> can contain.</param>
		/// <exception cref="ArgumentOutOfRangeException"><paramref name="capacity"/> is less than zero.</exception>
		public UnitTestFormCollection(IComparer comparer, int capacity) : this(capacity)
		{
			if (comparer != null)
				this.comparer = comparer;
		}
		...
		/// <summary>
		///		Initializes a new instance of the <see cref="UnitTestFormCollection"/> class that contains 
		...
		///		<para>-or-</para>
		///		<para><pararef name="d"/> contains elements of a type not supported by <see cref="UnitTestFormCollection"/>.</para>
		///	</exception>
		public UnitTestFormCollection(IDictionary d) : this(d, null) {}
		...
		///		<para><pararef name="d"/> contains elements of a type not supported by <see cref="UnitTestFormCollection"/>.</para>
		///	</exception>
		public UnitTestFormCollection(IDictionary d, IComparer comparer)
		...
		#region Properties
		/// <summary>
		///		Gets and sets the value associated with a specific key in the <b>UnitTestFormCollection</b>.
		/// </summary>
		/// <value>
		///		The <see cref="UnitTestItem"/> associated with <paramref name="key"/> in the <see cref="UnitTestFormCollection"/>,
		...
		///		Callers must either catch this exception, or call the <see cref="UnitTestFormCollection.Contains"/> method first to
		///		see if the key exists.
		/// </remarks>
		/// <exception cref="ArgumentNullException">The <paramref name="key"/> is a null reference.</exception>
		/// <exception cref="ArgumentException">
		///		Either the <paramref name="key"/> or the <paramref name="value"/> are not of a type supported by the <see cref="UnitTestFormCollection"/>.
		/// </exception>
		/// <exception cref="NullReferenceException">
		///		<paramref name="key"/> is not found in the <see cref="UnitTestFormCollection"/>.
		/// </exception>
		object IDictionary.this[object key]
		{
			...
			set
			{
				...
				if (!(value is UnitTestItem))
					throw new ArgumentException("The value must be of type: " + typeof(UnitTestItem).FullName, "value");

				this[(string)key] = (UnitTestItem)value;
			}
		}
		...
		///		<paramref name="key"/> is not found in the <see cref="UnitTestFormCollection"/>.
		/// </exception>
		public virtual UnitTestItem this[string key]
		{
			get
			{
		...
		/// <summary>
		///		Gets or sets the capacity of the <b>UnitTestFormCollection</b>.
		/// </summary>
		/// <value>The number of elements that the <see cref="UnitTestFormCollection"/> can contain.</value>
			...
			set
			{
				...
				if (value != keys.Length)
				{
					if (value > 0)
					{
						...
						UnitTestItem[] newValues = new UnitTestItem[value];
		...
		/// <summary>
		///		Gets the number of elements contained in the <b>UnitTestFormCollection</b>.
		/// </summary>
		/// <value>The number of elements contained in the <see cref="UnitTestFormCollection"/>.</value>
		...
		/// <summary>
		///		Gets a value indicating whether the <b>UnitTestFormCollection</b> has a fixed size.
		/// </summary>
		/// <value>
		///		<b>true</b> if the <see cref="UnitTestFormCollection"/> has a fixed size; otherwise, <b>false</b>.
		...
		/// <summary>
		///		Gets a value indicating whether the <b>UnitTestFormCollection</b> is read-only.
		/// </summary>
		/// <value>
		///		<b>true</b> if the <see cref="UnitTestFormCollection"/> is read-only; otherwise, <b>false</b>.
		///		The default is <b>false</b>.
		/// </value>
		...
		/// <summary>
		///		Gets a value indicating whether access to the <b>UnitTestFormCollection</b> is
		///		synchronized (thread-safe).
		/// </summary>
		/// <value>
		///		<b>true</b> if access to the the <see cref="UnitTestFormCollection"/> is 
		...
		/// <summary>
		///		Gets the keys in the <b>UnitTestFormCollection</b>.
		/// </summary>
		/// <value>An <see cref="ICollection"/> containing the keys in the <see cref="UnitTestFormCollection"/>.</value>
		/// <remarks>
		///		<para>The <see cref="ICollection"/> is a read-only view of the keys in the 
		///		<see cref="UnitTestFormCollection"/>. Modifications made to the underlying <b>UnitTestFormCollection</b>
		...
		///		of the <b>UnitTestFormCollection</b>.</para>
		///		<para>Similar to <see cref="UnitTestFormCollection.GetKeyList"/>, but returns an <b>ICollection</b>
		...
		/// <summary>
		///		Gets an object that can be used to synchronize access to the <b>UnitTestFormCollection</b>.
		/// </summary>
		/// <value>An object that can be used to synchronize access to the <see cref="UnitTestFormCollection"/>.</value>
		...
		/// <summary>
		///		Gets the values in the <b>UnitTestFormCollection</b>.
		/// </summary>
		/// <value>An <see cref="ICollection"/> containing the values in the <see cref="UnitTestFormCollection"/>.</value>
		/// <remarks>
		...
		///		of the <b>UnitTestFormCollection</b>.</para>
		///		<para>Similar to <see cref="UnitTestFormCollection.GetValueList"/>, but returns an <b>ICollection</b>
		///		instead of an <see cref="IList"/>.</para>
		/// </remarks>
		...
		/// <summary>
		///		Adds an element with the specified key and value to the <b>UnitTestFormCollection</b>.
		/// </summary>
		/// <param name="key">The key of the element to add.</param>
		/// <param name="value">The value of the element to add.</param>
		/// <exception cref="ArgumentNullException">The <paramref name="key"/> is a null reference.</exception>
		/// <exception cref="ArgumentException">
		///		<para>An element with the specified <paramref name="key"/> already exists in the <see cref="UnitTestFormCollection"/>.</para>
		///		<para>-or-</para>
		///		<para>Either the <paramref name="key"/> or the <paramref name="value"/> are not of a type supported by the <see cref="UnitTestFormCollection"/>.</para>
		///		<para>-or-</para>
		///		<para>The <b>UnitTestFormCollection</b> is set to use the <see cref="IComparable"/> interface,
		...
		///		<para>The <see cref="UnitTestFormCollection"/> is read-only.</para>
		///		<para>-or-</para>
		///		<para>The <b>UnitTestFormCollection</b> has a fixed size.</para>
		/// </exception>
		void IDictionary.Add(object key, object value)
		{
			...
			this.Add((string)key, (UnitTestItem)value);
		}
		...
		///		<para>The <b>UnitTestFormCollection</b> has a fixed size.</para>
		/// </exception>
		public virtual void Add(string key, UnitTestItem value)
		{
			if (Object.ReferenceEquals(key, null)) // avoids compiler error for null check on value type
				throw new ArgumentNullException("key", "The key cannot be null.");
		...
		/// <summary>
		///		Removes all elements from the <b>UnitTestFormCollection</b>.
		/// </summary>
		/// <exception cref="NotSupportedException">
		///		<para>The <see cref="UnitTestFormCollection"/> is read-only.</para>
		///		<para>-or-</para>
		...
		/// <summary>
		///		Determines whether the <b>UnitTestFormCollection</b> contains a specific key.
		/// </summary>
		/// <param name="key">The key to locate in the <see cref="UnitTestFormCollection"/>.</param>
		/// <exception cref="ArgumentNullException">The <paramref name="key"/> is a null reference.</exception>
		/// <exception cref="ArgumentException">
		///		The <paramref name="key"/> is not of a type supported by the <see cref="UnitTestFormCollection"/>.
		/// </exception>
		/// <exception cref="InvalidOperationException">The comparer throws an exception.</exception>
		/// <returns>
		///		<b>true</b> if the <see cref="UnitTestFormCollection"/> contains an element with the specified key; 
		///		otherwise, <b>false</b>.
		///	</returns>
		...
		/// <exception cref="InvalidOperationException">The comparer throws an exception.</exception>
		/// <returns>
		///		<b>true</b> if the <see cref="UnitTestFormCollection"/> contains an element with the specified 
		...
		/// <summary>
		///		Determines whether the <b>UnitTestFormCollection</b> contains a specific value.
		/// </summary>
		/// <param name="value">The value to locate in the <see cref="UnitTestFormCollection"/>.</param>
		/// <returns>
		///		<b>true</b> if the <see cref="UnitTestFormCollection"/> contains an element with the specified 
		///		<paramref name="value"/>; otherwise, <b>false</b>.
		/// </returns>
		public virtual bool ContainsValue(UnitTestItem value)
		{
			return (IndexOfValue(value) >= 0);
		}

		/// <summary>
		///		Copies the <see cref="UnitTestFormCollection"/> elements to a one-dimensional <see cref="System.Array"/>
		///		instance at the specified index.
		/// </summary>
		/// <param name="array">
		///		The one-dimensional <see cref="System.Array"/> that is the destination of the
		///		<see cref="DictionaryEntry"/> objects copied from <see cref="UnitTestFormCollection"/>.
		...
		///		<para>-or-</para>
		///		<para>The number of elements in the source <see cref="UnitTestFormCollection"/> is greater than the 
		///		available space from <paramref name="arrayIndex"/> to the end of the destination <paramref name="array"/>.</para>
		/// </exception>
		/// <exception cref="InvalidCastException">
		///		The type of the source <see cref="UnitTestFormCollection"/> cannot be cast automatically to the type
		...
		/// <summary>
		///		Gets the value at the specified index of the <b>UnitTestFormCollection</b>.
		/// </summary>
		/// <param name="index">The zero-based index of the value to get.</param>
		/// <returns>The value at the specified index of the <see cref="UnitTestFormCollection"/>.</returns>
		/// <exception cref="ArgumentOutOfRangeException">
		///		<paramref name="index"/> is outside the range of valid indices for the <see cref="UnitTestFormCollection"/>.
		/// </exception>
		public virtual UnitTestItem GetByIndex(int index)
		{
		...
		/// <summary>
		///		Returns an <see cref="IEnumerator"/> that can iterate through the <b>UnitTestFormCollection</b>.
		/// </summary>
		...
		///		<b>UnitTestFormCollection</b>.		
		/// </summary>
		/// <returns>An <see cref="IDictionaryEnumerator"/> for the <see cref="UnitTestFormCollection"/>.</returns>
		...
		/// <summary>
		///		Gets the key at the specified index of the <b>UnitTestFormCollection</b>.
		/// </summary>
		/// <param name="index">The zero-based index of the key to get.</param>
		/// <returns>The key at the specified index of the <see cref="UnitTestFormCollection"/>.</returns>
		/// <exception cref="ArgumentOutOfRangeException">
		///		<paramref name="index"/> is outside the range of valid indices for the <see cref="UnitTestFormCollection"/>.
		/// </exception>
		...
		///		Gets the keys in the <b>UnitTestFormCollection</b>.
		/// </summary>
		/// <returns>An <see cref="IList"/> containing the keys in the <see cref="UnitTestFormCollection"/>.</returns>
		/// <remarks>
		...
		///		of the <b>UnitTestFormCollection</b>.</para>
		///		<para>Similar to <see cref="UnitTestFormCollection.Keys"/>, but returns an <b>IList</b>
		...
		///		Gets the values in the <b>UnitTestFormCollection</b>.
		/// </summary>
		/// <returns>An <see cref="IList"/> containing the values in the <see cref="UnitTestFormCollection"/>.</returns>
		/// <remarks>
		...
		///		of the <b>UnitTestFormCollection</b>.</para>
		///		<para>Similar to <see cref="UnitTestFormCollection.Values"/>, but returns an <b>IList</b>
		///		instead of an <see cref="ICollection"/>.</para>
		/// </remarks>
		...
		/// <summary>
		///		Returns the zero-based index of the specified key in the <b>UnitTestFormCollection</b>.
		/// </summary>
		/// <param name="key">The key to locate in the <see cref="UnitTestFormCollection"/>.</param>
		/// <returns>
		///		The zero-based index of <paramref name="key"/>, if <paramref name="key"/> is found in
		///		the <see cref="UnitTestFormCollection"/>; otherwise, -1.
		/// </returns>
		/// <exception cref="ArgumentNullException"><paramref name="key"/> is a null reference.</exception>
		/// <exception cref="InvalidOperationException">The comparer throws an exception.</exception>
		/// <remarks>
		///		<para>The elements of a <see cref="UnitTestFormCollection"/> are sorted by the keys either 
		///		according to a specific <see cref="IComparer"/> implementation specified when the 
		///		<see cref="UnitTestFormCollection"/> is created or according to the <see cref="IComparable"/> 
		...
		///		it is inserted into <see cref="UnitTestFormCollection"/> in the correct sort order, and the 
		...
		///		removed from the <see cref="UnitTestFormCollection"/>.</para>
		///		<para>This method uses a binary search algorithm; therefore, the average execution time is 
		///		proportional to Log2(<i>n</i>), where <i>n</i> is <see cref="UnitTestFormCollection.Count"/>.</para>
		/// </remarks>
		...
		///		the <b>UnitTestFormCollection</b>.
		/// </summary>
		/// <param name="value">The value to locate in the <see cref="UnitTestFormCollection"/>.</param>
		/// <returns>
		...
		/// <remarks>
		///		<para>The index sequence is based on the sort sequence. When an element is added, 
		///		it is inserted into <see cref="UnitTestFormCollection"/> in the correct sort order, and 
		...
		///		elements are added or removed from the <see cref="UnitTestFormCollection"/>.</para>
		///		<para>The values of the elements of the <see cref="UnitTestFormCollection"/> are compared to the 
		...
		///		proportional to <see cref="UnitTestFormCollection.Count"/>.</para>
		/// </remarks>
		public virtual int IndexOfValue(UnitTestItem value)
		{
			return Array.IndexOf(values, value, 0, count);
		}

		/// <summary>
		///		Removes the element with the specified key from the <b>UnitTestFormCollection</b>.
		/// </summary>
		...
		/// </exception>
		/// <remarks>
		///		If the <see cref="UnitTestFormCollection"/> does not contain an element with the specified key,
		///		the <b>UnitTestFormCollection</b> remains unchanged. No exception is thrown.
		/// </remarks>
		...
		/// <summary>
		///		Removes the element at the specified index of the <b>UnitTestFormCollection</b>.
		/// </summary>
		...
		public virtual void RemoveAt(int index)
		{
			...
			UnitTestItem[] tempVal = new UnitTestItem[1];
		...
		/// <summary>
		///		Replaces the value at a specific index in the <b>UnitTestFormCollection</b>.
		/// </summary>
		/// <param name="index">The zero-based index at which to save <paramref name="value"/>.</param>
		/// <param name="value">The <see cref="UnitTestItem"/> to save into the <see cref="UnitTestFormCollection"/>.</param>
		/// <exception cref="ArgumentOutOfRangeException">
		///		<paramref name="index"/> is outside the range of valid indices for the <see cref="UnitTestFormCollection"/>.
		/// </exception>
		/// <remarks>
		...
		///		elements are added or removed from the <see cref="UnitTestFormCollection"/>.</para>
		/// </remarks>
		public virtual void SetByIndex(int index, UnitTestItem value)
		{
			if (index < 0 || index >= count)
				throw new ArgumentOutOfRangeException("index", index, "The index is outside the range of valid indices.");
		...
		/// <summary>
		///		Sets the capacity to the actual number of elements in the <b>UnitTestFormCollection</b>.
		/// </summary>
		/// <exception cref="NotSupportedException">
		///		<para>The <see cref="UnitTestFormCollection"/> is read-only.</para>
		///		<para>-or-</para>
		...
		private void Insert(int index, string key, UnitTestItem value)
		{
		...
		[Serializable]
			private class SyncSortedList : UnitTestFormCollection, IDictionary
		{
			private UnitTestFormCollection list;
			private object root;
			...
			public override UnitTestItem this[string key]
			{
				get
				{
					lock (root)
			...
			public override void Add(string key, UnitTestItem value)
			{
				lock (root)
					list.Add(key, value);
			}
			...
			public override bool ContainsValue(UnitTestItem value)
			{
				lock (root)
			...
			public override UnitTestItem GetByIndex(int index)
			{
				lock (root)
			...
			public override int IndexOfValue(UnitTestItem value)
			{
				lock (root)
			...
			public override void SetByIndex(int index, UnitTestItem value)
			{
				lock (root)
			...
			private class SortedListEnumerator : IDictionaryEnumerator, ICloneable
		{
			...
			public virtual UnitTestItem Value
			{
				get
				{
					CheckState();
			...
			private class ValueList : IList
		{
			...
			internal ValueList(UnitTestFormCollection list)
			{
				this.list = list;
			}
			...
			bool IList.Contains(object value)
			{
				...
				return list.ContainsValue((UnitTestItem)value);
			}

			public virtual bool Contains(UnitTestItem value)
			{
				return list.ContainsValue(value);
			}
			...
			object IList.this[int index]
			{
				...
				set
				{
					...
					list.SetByIndex(index, (UnitTestItem)value);
				}
			}

			public virtual UnitTestItem this[int index]
			{
				get
				{
					return list.GetByIndex(index);
			...
			int IList.IndexOf(object value)
			{
				...
				return list.IndexOfValue((UnitTestItem)value);
			}

			public virtual int IndexOf(UnitTestItem value)
			{
				return list.IndexOfValue(value);
			}
