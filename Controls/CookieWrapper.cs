...
namespace Ecyware.GreenBlue.Controls
{
	...
	public class CookieWrapper : ExpandableObjectConverter
	{
		...
		{
			if ( destinationType == typeof(string) && value is CookieWrapper )
			{
				CookieWrapper ckyWrapper = (CookieWrapper)value;
