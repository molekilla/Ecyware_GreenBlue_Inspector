...
{
	/// <summary>
	/// Contains the definition for the FindReplaceForm type.
	/// </summary>
	public class FindReplaceForm : System.Windows.Forms.Form
	{
		#region Form+EventHandler Code
		protected System.Windows.Forms.Panel pnlButtons;
		protected System.Windows.Forms.Panel pnlFind;
		protected System.Windows.Forms.Panel pnlReplace;
		protected System.Windows.Forms.Panel pnlSettings;
		protected System.Windows.Forms.Label label1;
		protected System.Windows.Forms.Button btnRegex1;
		protected System.Windows.Forms.Button button1;
		protected System.Windows.Forms.Label label2;
		protected System.Windows.Forms.Panel panel1;
		protected System.Windows.Forms.Panel panel3;
		protected System.Windows.Forms.Panel pnlReplaceButtons;
		protected System.Windows.Forms.GroupBox groupBox1;
		protected System.Windows.Forms.ComboBox cboFind;
		protected System.Windows.Forms.ComboBox cboReplace;
		protected System.Windows.Forms.Button btnReplace;
		/// <summary>
		...
		protected System.Windows.Forms.Button btnReplaceAll;
		protected System.Windows.Forms.CheckBox chkRegEx;
		protected System.Windows.Forms.Button btnMarkAll;

		private WeakReference					_Control=null;

		private Compona.Windows.Forms.SyntaxBoxControl OwnerControl
		{
			get
			{
				if (_Control!=null)
					return (Compona.Windows.Forms.SyntaxBoxControl)_Control.Target;
				else
					return null;
			}
			set
		...
		protected System.Windows.Forms.Button btnDoReplace;
		private string _Last			="";

		/// <summary>
		/// Default constructor for the FindReplaceForm.
		/// This is needed by the designer , do not use!
		/// </summary>
		...
		public FindReplaceForm(Compona.Windows.Forms.SyntaxBoxControl Owner)
		{
			//
			// Required for Windows Form Designer support
			//
		...
		private void FindReplace_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			e.Cancel =true;
			this.Hide ();
		}
		...
		private void btnDoReplace_Click(object sender, System.EventArgs e)
		{
			this.ReplaceCurrent(cboReplace.Text);			
		...
		private void btnReplaceAll_Click(object sender, System.EventArgs e)
		{
			...
			int x=OwnerControl.Caret.Position.X;
			int y=OwnerControl.Caret.Position.Y;
			OwnerControl.Caret.Position.X=0;
			OwnerControl.Caret.Position.Y=0;

			this.ReplaceAll (cboFind.Text,chkMatchCase.Checked,chkWholeWord.Checked,chkRegEx.Checked);

			OwnerControl.Selection.ClearSelection ();
		...
		private void btnMarkAll_Click(object sender, System.EventArgs e)
		{
			...
			this.MarkAll (cboFind.Text,chkMatchCase.Checked,chkWholeWord.Checked,chkRegEx.Checked);
		...
		public void FindNext()
		{
			...
			if (_Last!="" && _Last != text)
			{
				this.OwnerControl.Caret.Position.X =0;
				this.OwnerControl.Caret.Position.Y =0;
				this.OwnerControl.ScrollIntoView ();
			}
			...
			this.FindNext  (cboFind.Text,chkMatchCase.Checked,chkWholeWord.Checked,chkRegEx.Checked);
		}
		#endregion

		protected virtual bool FindNext(string Pattern,bool MatchCase,bool WholeWord,bool UseRegex)
		{
			//***************************************
			//*										*
			//*	Add code to 'find next' here	    *
			//*										*
			//***************************************

			int r=OwnerControl.Selection.Bounds.FirstRow;
			int c=OwnerControl.Selection.Bounds.FirstColumn;

			OwnerControl.FindNext  (cboFind.Text,chkMatchCase.Checked,chkWholeWord.Checked,chkRegEx.Checked);

			int r2=OwnerControl.Selection.Bounds.FirstRow;
			int c2=OwnerControl.Selection.Bounds.FirstColumn;

			//return if the selection has changed..
			return r2!=r || c2!=c;			
		}

		protected virtual void ReplaceCurrent(string Text)
		{
			//***************************************
			//*										*
			//*	Add code to 'replace' here	        *
			//*										*
			//***************************************

			this.OwnerControl.Selection.Text = Text;
		}

		protected virtual void MarkAll(string Pattern,bool MatchCase,bool WholeWord,bool UseRegex)
		{
			//***************************************
			//*										*
			//*	Add code to 'mark all' here		    *
			//*										*
			//***************************************

			while(this.FindNext (cboFind.Text,chkMatchCase.Checked,chkWholeWord.Checked,chkRegEx.Checked))
			{				
				this.OwnerControl.Caret.CurrentRow.Bookmarked =true;
			}
		}

		protected virtual void ReplaceAll(string Pattern,bool MatchCase,bool WholeWord,bool UseRegex)
		{
			//***************************************
			//*										*
			//*	Add code to 'replace all' here		*
			//*										*
			//***************************************
