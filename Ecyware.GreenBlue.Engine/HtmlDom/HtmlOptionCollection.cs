...
namespace Ecyware.GreenBlue.Engine.HtmlDom
{
	...
	[Serializable]
	public class HtmlOptionCollection : IDictionary, ICloneable
	{
		#region Member Variables
		private const int DEFAULT_CAPACITY = 16;

		private string[] keys;
		private HtmlOptionTag[] values;
		private int count;
		[NonSerialized]
		private int version;
		...
		#region Constructors
		/// <summary>
		///		Initializes a new instance of the <see cref="HtmlOptionCollection"/> class that is empty, 
		///		has the default initial capacity and is sorted according to the <see cref="IComparable"/> interface 
		///		implemented by each key added to the <b>HtmlOptionCollection</b>.
		/// </summary>
		public HtmlOptionCollection()
		{
			keys = new string[DEFAULT_CAPACITY];
			values = new HtmlOptionTag[DEFAULT_CAPACITY];
		...
		///		interface implemented by each key added to the <b>HtmlOptionCollection</b>.
		/// </summary>
		/// <param name="capacity">The initial number of elements that the <see cref="HtmlOptionCollection"/> can contain.</param>
		/// <exception cref="ArgumentOutOfRangeException"><paramref name="capacity"/> is less than zero.</exception>
		public HtmlOptionCollection(int capacity)
		{
			if (capacity < 0)
				throw new ArgumentOutOfRangeException("capacity", capacity, "Initial capacity cannot be less than zero.");

			keys = new string[capacity];
			values = new HtmlOptionTag[capacity];
			comparer = Comparer.Default;
		}
		...
		/// </param>
		public HtmlOptionCollection(IComparer comparer) : this()
		{
			if (comparer != null)
		...
		/// <param name="capacity">The initial number of elements that the <see cref="HtmlOptionCollection"/> can contain.</param>
		/// <exception cref="ArgumentOutOfRangeException"><paramref name="capacity"/> is less than zero.</exception>
		public HtmlOptionCollection(IComparer comparer, int capacity) : this(capacity)
		{
			if (comparer != null)
				this.comparer = comparer;
		}
		...
		/// <summary>
		///		Initializes a new instance of the <see cref="HtmlOptionCollection"/> class that contains 
		...
		///		<para>-or-</para>
		///		<para><pararef name="d"/> contains elements of a type not supported by <see cref="HtmlOptionCollection"/>.</para>
		///	</exception>
		public HtmlOptionCollection(IDictionary d) : this(d, null) {}
		...
		///		<para><pararef name="d"/> contains elements of a type not supported by <see cref="HtmlOptionCollection"/>.</para>
		///	</exception>
		public HtmlOptionCollection(IDictionary d, IComparer comparer)
		...
		#region Properties
		/// <summary>
		///		Gets and sets the value associated with a specific key in the <b>HtmlOptionCollection</b>.
		/// </summary>
		/// <value>
		///		The <see cref="HtmlOptionTag"/> associated with <paramref name="key"/> in the <see cref="HtmlOptionCollection"/>,
		...
		///		Callers must either catch this exception, or call the <see cref="HtmlOptionCollection.Contains"/> method first to
		///		see if the key exists.
		/// </remarks>
		/// <exception cref="ArgumentNullException">The <paramref name="key"/> is a null reference.</exception>
		/// <exception cref="ArgumentException">
		///		Either the <paramref name="key"/> or the <paramref name="value"/> are not of a type supported by the <see cref="HtmlOptionCollection"/>.
		/// </exception>
		/// <exception cref="NullReferenceException">
		///		<paramref name="key"/> is not found in the <see cref="HtmlOptionCollection"/>.
		/// </exception>
		object IDictionary.this[object key]
		{
			...
			set
			{
				...
				if (!(value is HtmlOptionTag))
					throw new ArgumentException("The value must be of type: " + typeof(HtmlOptionTag).FullName, "value");

				this[(string)key] = (HtmlOptionTag)value;
			}
		}
		...
		///		<paramref name="key"/> is not found in the <see cref="HtmlOptionCollection"/>.
		/// </exception>
		public virtual HtmlOptionTag this[string key]
		{
			get
			{
		...
		/// <summary>
		///		Gets or sets the capacity of the <b>HtmlOptionCollection</b>.
		/// </summary>
		/// <value>The number of elements that the <see cref="HtmlOptionCollection"/> can contain.</value>
			...
			set
			{
				...
				if (value != keys.Length)
				{
					if (value > 0)
					{
						...
						HtmlOptionTag[] newValues = new HtmlOptionTag[value];
		...
		/// <summary>
		///		Gets the number of elements contained in the <b>HtmlOptionCollection</b>.
		/// </summary>
		/// <value>The number of elements contained in the <see cref="HtmlOptionCollection"/>.</value>
		...
		/// <summary>
		///		Gets a value indicating whether the <b>HtmlOptionCollection</b> has a fixed size.
		/// </summary>
		/// <value>
		///		<b>true</b> if the <see cref="HtmlOptionCollection"/> has a fixed size; otherwise, <b>false</b>.
		...
		/// <summary>
		///		Gets a value indicating whether the <b>HtmlOptionCollection</b> is read-only.
		/// </summary>
		/// <value>
		///		<b>true</b> if the <see cref="HtmlOptionCollection"/> is read-only; otherwise, <b>false</b>.
		///		The default is <b>false</b>.
		/// </value>
		...
		/// <summary>
		///		Gets a value indicating whether access to the <b>HtmlOptionCollection</b> is
		///		synchronized (thread-safe).
		/// </summary>
		/// <value>
		///		<b>true</b> if access to the the <see cref="HtmlOptionCollection"/> is 
		...
		/// <summary>
		///		Gets the keys in the <b>HtmlOptionCollection</b>.
		/// </summary>
		/// <value>An <see cref="ICollection"/> containing the keys in the <see cref="HtmlOptionCollection"/>.</value>
		/// <remarks>
		///		<para>The <see cref="ICollection"/> is a read-only view of the keys in the 
		///		<see cref="HtmlOptionCollection"/>. Modifications made to the underlying <b>HtmlOptionCollection</b>
		...
		///		of the <b>HtmlOptionCollection</b>.</para>
		///		<para>Similar to <see cref="HtmlOptionCollection.GetKeyList"/>, but returns an <b>ICollection</b>
		...
		/// <summary>
		///		Gets an object that can be used to synchronize access to the <b>HtmlOptionCollection</b>.
		/// </summary>
		/// <value>An object that can be used to synchronize access to the <see cref="HtmlOptionCollection"/>.</value>
		...
		/// <summary>
		///		Gets the values in the <b>HtmlOptionCollection</b>.
		/// </summary>
		/// <value>An <see cref="ICollection"/> containing the values in the <see cref="HtmlOptionCollection"/>.</value>
		/// <remarks>
		...
		///		of the <b>HtmlOptionCollection</b>.</para>
		///		<para>Similar to <see cref="HtmlOptionCollection.GetValueList"/>, but returns an <b>ICollection</b>
		///		instead of an <see cref="IList"/>.</para>
		/// </remarks>
		...
		///		<para>-or-</para>
		///		<para>Either the <paramref name="key"/> or the <paramref name="value"/> are not of a type supported by the <see cref="HtmlOptionCollection"/>.</para>
		///		<para>-or-</para>
		...
		void IDictionary.Add(object key, object value)
		{
			...
			this.Add((string)key, (HtmlOptionTag)value);
		}
		...
		/// <summary>
		///		Removes all elements from the <b>HtmlOptionCollection</b>.
		/// </summary>
		/// <exception cref="NotSupportedException">
		///		<para>The <see cref="HtmlOptionCollection"/> is read-only.</para>
		///		<para>-or-</para>
		...
		/// <summary>
		///		Determines whether the <b>HtmlOptionCollection</b> contains a specific key.
		/// </summary>
		/// <param name="key">The key to locate in the <see cref="HtmlOptionCollection"/>.</param>
		/// <exception cref="ArgumentNullException">The <paramref name="key"/> is a null reference.</exception>
		/// <exception cref="ArgumentException">
		///		The <paramref name="key"/> is not of a type supported by the <see cref="HtmlOptionCollection"/>.
		/// </exception>
		/// <exception cref="InvalidOperationException">The comparer throws an exception.</exception>
		/// <returns>
		///		<b>true</b> if the <see cref="HtmlOptionCollection"/> contains an element with the specified key; 
		///		otherwise, <b>false</b>.
		///	</returns>
		...
		/// <summary>
		///		Copies the <see cref="HtmlOptionCollection"/> elements to a one-dimensional <see cref="System.Array"/>
		///		instance at the specified index.
		/// </summary>
		/// <param name="array">
		///		The one-dimensional <see cref="System.Array"/> that is the destination of the
		///		<see cref="DictionaryEntry"/> objects copied from <see cref="HtmlOptionCollection"/>.
		...
		///		<para>-or-</para>
		///		<para>The number of elements in the source <see cref="HtmlOptionCollection"/> is greater than the 
		///		available space from <paramref name="arrayIndex"/> to the end of the destination <paramref name="array"/>.</para>
		/// </exception>
		/// <exception cref="InvalidCastException">
		///		The type of the source <see cref="HtmlOptionCollection"/> cannot be cast automatically to the type
		...
		/// <summary>
		///		Gets the value at the specified index of the <b>HtmlOptionCollection</b>.
		/// </summary>
		/// <param name="index">The zero-based index of the value to get.</param>
		/// <returns>The value at the specified index of the <see cref="HtmlOptionCollection"/>.</returns>
		/// <exception cref="ArgumentOutOfRangeException">
		///		<paramref name="index"/> is outside the range of valid indices for the <see cref="HtmlOptionCollection"/>.
		/// </exception>
		public virtual HtmlOptionTag GetByIndex(int index)
		{
		...
		/// <summary>
		///		Returns an <see cref="IEnumerator"/> that can iterate through the <b>HtmlOptionCollection</b>.
		/// </summary>
		...
		///		<b>HtmlOptionCollection</b>.		
		/// </summary>
		/// <returns>An <see cref="IDictionaryEnumerator"/> for the <see cref="HtmlOptionCollection"/>.</returns>
		...
		/// <summary>
		///		Gets the key at the specified index of the <b>HtmlOptionCollection</b>.
		/// </summary>
		/// <param name="index">The zero-based index of the key to get.</param>
		/// <returns>The key at the specified index of the <see cref="HtmlOptionCollection"/>.</returns>
		/// <exception cref="ArgumentOutOfRangeException">
		///		<paramref name="index"/> is outside the range of valid indices for the <see cref="HtmlOptionCollection"/>.
		/// </exception>
		...
		///		Gets the keys in the <b>HtmlOptionCollection</b>.
		/// </summary>
		/// <returns>An <see cref="IList"/> containing the keys in the <see cref="HtmlOptionCollection"/>.</returns>
		/// <remarks>
		...
		///		of the <b>HtmlOptionCollection</b>.</para>
		///		<para>Similar to <see cref="HtmlOptionCollection.Keys"/>, but returns an <b>IList</b>
		...
		///		Gets the values in the <b>HtmlOptionCollection</b>.
		/// </summary>
		/// <returns>An <see cref="IList"/> containing the values in the <see cref="HtmlOptionCollection"/>.</returns>
		/// <remarks>
		...
		///		of the <b>HtmlOptionCollection</b>.</para>
		///		<para>Similar to <see cref="HtmlOptionCollection.Values"/>, but returns an <b>IList</b>
		///		instead of an <see cref="ICollection"/>.</para>
		/// </remarks>
		...
		/// <summary>
		///		Returns the zero-based index of the specified key in the <b>HtmlOptionCollection</b>.
		/// </summary>
		/// <param name="key">The key to locate in the <see cref="HtmlOptionCollection"/>.</param>
		/// <returns>
		...
		/// <exception cref="InvalidOperationException">The comparer throws an exception.</exception>
		/// <remarks>
		///		<para>The elements of a <see cref="HtmlOptionCollection"/> are sorted by the keys either 
		///		according to a specific <see cref="IComparer"/> implementation specified when the 
		///		<see cref="HtmlOptionCollection"/> is created or according to the <see cref="IComparable"/> 
		...
		///		it is inserted into <see cref="HtmlOptionCollection"/> in the correct sort order, and the 
		...
		///		removed from the <see cref="HtmlOptionCollection"/>.</para>
		///		<para>This method uses a binary search algorithm; therefore, the average execution time is 
		///		proportional to Log2(<i>n</i>), where <i>n</i> is <see cref="HtmlOptionCollection.Count"/>.</para>
		/// </remarks>
		...
		/// <summary>
		///		Removes the element with the specified key from the <b>HtmlOptionCollection</b>.
		/// </summary>
		...
		/// </exception>
		/// <remarks>
		///		If the <see cref="HtmlOptionCollection"/> does not contain an element with the specified key,
		///		the <b>HtmlOptionCollection</b> remains unchanged. No exception is thrown.
		/// </remarks>
		...
		/// <summary>
		///		Sets the capacity to the actual number of elements in the <b>HtmlOptionCollection</b>.
		/// </summary>
		/// <exception cref="NotSupportedException">
		///		<para>The <see cref="HtmlOptionCollection"/> is read-only.</para>
		///		<para>-or-</para>
		...
		[Serializable]
			private class SyncSortedList : HtmlOptionCollection, IDictionary
		{
			private HtmlOptionCollection list;
			private object root;
			...
			public override HtmlOptionTag this[string key]
			{
				get
				{
					lock (root)
			...
			public override HtmlOptionTag GetByIndex(int index)
			{
				lock (root)
			...
			private class SortedListEnumerator : IDictionaryEnumerator, ICloneable
		{
			...
			public virtual HtmlOptionTag Value
			{
				get
				{
					CheckState();
			...
			private class ValueList : IList
		{
			...
			bool IList.Contains(object value)
			{
				...
				return list.ContainsValue((HtmlOptionTag)value);
			}
			...
			object IList.this[int index]
			{
				...
				set
				{
					...
					list.SetByIndex(index, (HtmlOptionTag)value);
				}
			}

			public virtual HtmlOptionTag this[int index]
			{
				get
				{
					return list.GetByIndex(index);
			...
			int IList.IndexOf(object value)
			{
				...
				return list.IndexOfValue((HtmlOptionTag)value);
			}
