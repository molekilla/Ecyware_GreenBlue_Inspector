...
/// </summary>
public class PostDataCollection : NameObjectCollectionBase  
{

	private DictionaryEntry _de = new DictionaryEntry();

	// Creates an empty collection.
	public PostDataCollection()  
	{
	}

	// Adds elements from an IDictionary into the new collection.
	public PostDataCollection( IDictionary d, Boolean bReadOnly )  
	{
	...
	public ArrayList this[ String key ]  
	{
		get  
		{
			return( (ArrayList)this.BaseGet( key ) );
		}
		set  
		{
