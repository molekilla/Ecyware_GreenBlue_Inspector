...
namespace Ecyware.GreenBlue.Engine
{
	...
	public class TestCollection : IDictionary, ICloneable
	{
		...
		#region Constructors
		/// <summary>
		///		Initializes a new instance of the <see cref="TestCollection"/> class that is empty, 
		///		has the default initial capacity and is sorted according to the <see cref="IComparable"/> interface 
		///		implemented by each key added to the <b>TestCollection</b>.
		/// </summary>
		public TestCollection()
		{
			keys = new string[DEFAULT_CAPACITY];
			values = new Test[DEFAULT_CAPACITY];
		...
		///		interface implemented by each key added to the <b>TestCollection</b>.
		/// </summary>
		/// <param name="capacity">The initial number of elements that the <see cref="TestCollection"/> can contain.</param>
		...
		/// </param>
		public TestCollection(IComparer comparer) : this()
		{
			if (comparer != null)
		...
		/// <param name="capacity">The initial number of elements that the <see cref="TestCollection"/> can contain.</param>
		/// <exception cref="ArgumentOutOfRangeException"><paramref name="capacity"/> is less than zero.</exception>
		public TestCollection(IComparer comparer, int capacity) : this(capacity)
		{
			if (comparer != null)
				this.comparer = comparer;
		}
		...
		/// <summary>
		///		Initializes a new instance of the <see cref="TestCollection"/> class that contains 
		...
		///		<para>-or-</para>
		///		<para><pararef name="d"/> contains elements of a type not supported by <see cref="TestCollection"/>.</para>
		///	</exception>
		public TestCollection(IDictionary d) : this(d, null) {}
		...
		///		<para><pararef name="d"/> contains elements of a type not supported by <see cref="TestCollection"/>.</para>
		///	</exception>
		public TestCollection(IDictionary d, IComparer comparer)
		...
		#region Properties
		/// <summary>
		///		Gets and sets the value associated with a specific key in the <b>TestCollection</b>.
		/// </summary>
		/// <value>
		///		The <see cref="Test"/> associated with <paramref name="key"/> in the <see cref="TestCollection"/>,
		...
		///		Callers must either catch this exception, or call the <see cref="TestCollection.Contains"/> method first to
		///		see if the key exists.
		/// </remarks>
		/// <exception cref="ArgumentNullException">The <paramref name="key"/> is a null reference.</exception>
		/// <exception cref="ArgumentException">
		///		Either the <paramref name="key"/> or the <paramref name="value"/> are not of a type supported by the <see cref="TestCollection"/>.
		/// </exception>
		/// <exception cref="NullReferenceException">
		///		<paramref name="key"/> is not found in the <see cref="TestCollection"/>.
		/// </exception>
		object IDictionary.this[object key]
		{
			...
			set
			{
				...
				if (!(value is Test))
					throw new ArgumentException("The value must be of type: " + typeof(Test).FullName, "value");

				this[(string)key] = (Test)value;
			}
		}
		...
		///		<paramref name="key"/> is not found in the <see cref="TestCollection"/>.
		/// </exception>
		public virtual Test this[string key]
		{
			get
			{
		...
		/// <summary>
		///		Gets or sets the capacity of the <b>TestCollection</b>.
		/// </summary>
		/// <value>The number of elements that the <see cref="TestCollection"/> can contain.</value>
		...
		/// <summary>
		///		Gets the number of elements contained in the <b>TestCollection</b>.
		/// </summary>
		/// <value>The number of elements contained in the <see cref="TestCollection"/>.</value>
		...
		/// <summary>
		///		Gets a value indicating whether the <b>TestCollection</b> has a fixed size.
		/// </summary>
		/// <value>
		///		<b>true</b> if the <see cref="TestCollection"/> has a fixed size; otherwise, <b>false</b>.
		...
		/// <summary>
		///		Gets a value indicating whether the <b>TestCollection</b> is read-only.
		/// </summary>
		/// <value>
		///		<b>true</b> if the <see cref="TestCollection"/> is read-only; otherwise, <b>false</b>.
		///		The default is <b>false</b>.
		/// </value>
		...
		/// <summary>
		///		Gets a value indicating whether access to the <b>TestCollection</b> is
		///		synchronized (thread-safe).
		/// </summary>
		/// <value>
		///		<b>true</b> if access to the the <see cref="TestCollection"/> is 
		...
		/// <summary>
		///		Gets the keys in the <b>TestCollection</b>.
		/// </summary>
		/// <value>An <see cref="ICollection"/> containing the keys in the <see cref="TestCollection"/>.</value>
		/// <remarks>
		///		<para>The <see cref="ICollection"/> is a read-only view of the keys in the 
		///		<see cref="TestCollection"/>. Modifications made to the underlying <b>TestCollection</b>
		...
		///		of the <b>TestCollection</b>.</para>
		///		<para>Similar to <see cref="TestCollection.GetKeyList"/>, but returns an <b>ICollection</b>
		...
		/// <summary>
		///		Gets an object that can be used to synchronize access to the <b>TestCollection</b>.
		/// </summary>
		/// <value>An object that can be used to synchronize access to the <see cref="TestCollection"/>.</value>
		...
		/// <summary>
		///		Gets the values in the <b>TestCollection</b>.
		/// </summary>
		/// <value>An <see cref="ICollection"/> containing the values in the <see cref="TestCollection"/>.</value>
		/// <remarks>
		...
		///		of the <b>TestCollection</b>.</para>
		///		<para>Similar to <see cref="TestCollection.GetValueList"/>, but returns an <b>ICollection</b>
		///		instead of an <see cref="IList"/>.</para>
		/// </remarks>
		...
		/// <summary>
		///		Adds an element with the specified key and value to the <b>TestCollection</b>.
		/// </summary>
		/// <param name="key">The key of the element to add.</param>
		/// <param name="value">The value of the element to add.</param>
		/// <exception cref="ArgumentNullException">The <paramref name="key"/> is a null reference.</exception>
		/// <exception cref="ArgumentException">
		///		<para>An element with the specified <paramref name="key"/> already exists in the <see cref="TestCollection"/>.</para>
		///		<para>-or-</para>
		///		<para>Either the <paramref name="key"/> or the <paramref name="value"/> are not of a type supported by the <see cref="TestCollection"/>.</para>
		///		<para>-or-</para>
		///		<para>The <b>TestCollection</b> is set to use the <see cref="IComparable"/> interface,
		...
		///		<para>The <see cref="TestCollection"/> is read-only.</para>
		///		<para>-or-</para>
		///		<para>The <b>TestCollection</b> has a fixed size.</para>
		/// </exception>
		void IDictionary.Add(object key, object value)
		{
			...
			this.Add((string)key, (Test)value);
		}
		...
		///		<para>The <b>TestCollection</b> has a fixed size.</para>
		/// </exception>
		public virtual void Add(string key, Test value)
		{
			if (Object.ReferenceEquals(key, null)) // avoids compiler error for null check on value type
				throw new ArgumentNullException("key", "The key cannot be null.");
		...
		/// <summary>
		///		Removes all elements from the <b>TestCollection</b>.
		/// </summary>
		/// <exception cref="NotSupportedException">
		///		<para>The <see cref="TestCollection"/> is read-only.</para>
		///		<para>-or-</para>
		...
		/// <summary>
		///		Determines whether the <b>TestCollection</b> contains a specific key.
		/// </summary>
		/// <param name="key">The key to locate in the <see cref="TestCollection"/>.</param>
		/// <exception cref="ArgumentNullException">The <paramref name="key"/> is a null reference.</exception>
		/// <exception cref="ArgumentException">
		///		The <paramref name="key"/> is not of a type supported by the <see cref="TestCollection"/>.
		/// </exception>
		/// <exception cref="InvalidOperationException">The comparer throws an exception.</exception>
		/// <returns>
		///		<b>true</b> if the <see cref="TestCollection"/> contains an element with the specified key; 
		///		otherwise, <b>false</b>.
		///	</returns>
		...
		/// <exception cref="InvalidOperationException">The comparer throws an exception.</exception>
		/// <returns>
		///		<b>true</b> if the <see cref="TestCollection"/> contains an element with the specified 
		...
		/// <summary>
		///		Determines whether the <b>TestCollection</b> contains a specific value.
		/// </summary>
		/// <param name="value">The value to locate in the <see cref="TestCollection"/>.</param>
		/// <returns>
		///		<b>true</b> if the <see cref="TestCollection"/> contains an element with the specified 
		///		<paramref name="value"/>; otherwise, <b>false</b>.
		/// </returns>
		public virtual bool ContainsValue(Test value)
		{
			return (IndexOfValue(value) >= 0);
		}

		/// <summary>
		///		Copies the <see cref="TestCollection"/> elements to a one-dimensional <see cref="System.Array"/>
		///		instance at the specified index.
		/// </summary>
		/// <param name="array">
		///		The one-dimensional <see cref="System.Array"/> that is the destination of the
		///		<see cref="DictionaryEntry"/> objects copied from <see cref="TestCollection"/>.
		...
		///		<para>-or-</para>
		///		<para>The number of elements in the source <see cref="TestCollection"/> is greater than the 
		///		available space from <paramref name="arrayIndex"/> to the end of the destination <paramref name="array"/>.</para>
		/// </exception>
		/// <exception cref="InvalidCastException">
		///		The type of the source <see cref="TestCollection"/> cannot be cast automatically to the type
		...
		/// <summary>
		///		Gets the value at the specified index of the <b>TestCollection</b>.
		/// </summary>
		/// <param name="index">The zero-based index of the value to get.</param>
		/// <returns>The value at the specified index of the <see cref="TestCollection"/>.</returns>
		/// <exception cref="ArgumentOutOfRangeException">
		///		<paramref name="index"/> is outside the range of valid indices for the <see cref="TestCollection"/>.
		/// </exception>
		public virtual Test GetByIndex(int index)
		{
		...
		/// <summary>
		///		Returns an <see cref="IEnumerator"/> that can iterate through the <b>TestCollection</b>.
		/// </summary>
		...
		///		<b>TestCollection</b>.		
		/// </summary>
		/// <returns>An <see cref="IDictionaryEnumerator"/> for the <see cref="TestCollection"/>.</returns>
		...
		/// <summary>
		///		Gets the key at the specified index of the <b>TestCollection</b>.
		/// </summary>
		/// <param name="index">The zero-based index of the key to get.</param>
		/// <returns>The key at the specified index of the <see cref="TestCollection"/>.</returns>
		/// <exception cref="ArgumentOutOfRangeException">
		///		<paramref name="index"/> is outside the range of valid indices for the <see cref="TestCollection"/>.
		/// </exception>
		...
		///		Gets the keys in the <b>TestCollection</b>.
		/// </summary>
		/// <returns>An <see cref="IList"/> containing the keys in the <see cref="TestCollection"/>.</returns>
		/// <remarks>
		...
		///		of the <b>TestCollection</b>.</para>
		///		<para>Similar to <see cref="TestCollection.Keys"/>, but returns an <b>IList</b>
		...
		///		Gets the values in the <b>TestCollection</b>.
		/// </summary>
		/// <returns>An <see cref="IList"/> containing the values in the <see cref="TestCollection"/>.</returns>
		/// <remarks>
		...
		///		of the <b>TestCollection</b>.</para>
		///		<para>Similar to <see cref="TestCollection.Values"/>, but returns an <b>IList</b>
		///		instead of an <see cref="ICollection"/>.</para>
		/// </remarks>
		...
		/// <summary>
		///		Returns the zero-based index of the specified key in the <b>TestCollection</b>.
		/// </summary>
		/// <param name="key">The key to locate in the <see cref="TestCollection"/>.</param>
		/// <returns>
		///		The zero-based index of <paramref name="key"/>, if <paramref name="key"/> is found in
		///		the <see cref="TestCollection"/>; otherwise, -1.
		/// </returns>
		/// <exception cref="ArgumentNullException"><paramref name="key"/> is a null reference.</exception>
		/// <exception cref="InvalidOperationException">The comparer throws an exception.</exception>
		/// <remarks>
		///		<para>The elements of a <see cref="TestCollection"/> are sorted by the keys either 
		///		according to a specific <see cref="IComparer"/> implementation specified when the 
		///		<see cref="TestCollection"/> is created or according to the <see cref="IComparable"/> 
		...
		///		it is inserted into <see cref="TestCollection"/> in the correct sort order, and the 
		...
		///		removed from the <see cref="TestCollection"/>.</para>
		///		<para>This method uses a binary search algorithm; therefore, the average execution time is 
		///		proportional to Log2(<i>n</i>), where <i>n</i> is <see cref="TestCollection.Count"/>.</para>
		/// </remarks>
		...
		/// <remarks>
		///		<para>The index sequence is based on the sort sequence. When an element is added, 
		///		it is inserted into <see cref="TestCollection"/> in the correct sort order, and 
		...
		///		elements are added or removed from the <see cref="TestCollection"/>.</para>
		///		<para>The values of the elements of the <see cref="TestCollection"/> are compared to the 
		...
		///		proportional to <see cref="TestCollection.Count"/>.</para>
		/// </remarks>
		public virtual int IndexOfValue(Test value)
		{
			return Array.IndexOf(values, value, 0, count);
		}

		/// <summary>
		///		Removes the element with the specified key from the <b>TestCollection</b>.
		/// </summary>
		...
		/// </exception>
		/// <remarks>
		///		If the <see cref="TestCollection"/> does not contain an element with the specified key,
		///		the <b>TestCollection</b> remains unchanged. No exception is thrown.
		/// </remarks>
		...
		/// <summary>
		///		Removes the element at the specified index of the <b>TestCollection</b>.
		/// </summary>
		...
		/// <summary>
		///		Replaces the value at a specific index in the <b>TestCollection</b>.
		/// </summary>
		/// <param name="index">The zero-based index at which to save <paramref name="value"/>.</param>
		/// <param name="value">The <see cref="Test"/> to save into the <see cref="TestCollection"/>.</param>
		/// <exception cref="ArgumentOutOfRangeException">
		///		<paramref name="index"/> is outside the range of valid indices for the <see cref="TestCollection"/>.
		/// </exception>
		/// <remarks>
		...
		///		elements are added or removed from the <see cref="TestCollection"/>.</para>
		/// </remarks>
		public virtual void SetByIndex(int index, Test value)
		{
			if (index < 0 || index >= count)
				throw new ArgumentOutOfRangeException("index", index, "The index is outside the range of valid indices.");
		...
		/// <summary>
		///		Sets the capacity to the actual number of elements in the <b>TestCollection</b>.
		/// </summary>
		/// <exception cref="NotSupportedException">
		///		<para>The <see cref="TestCollection"/> is read-only.</para>
		///		<para>-or-</para>
		...
		private void Insert(int index, string key, Test value)
		{
		...
		[Serializable]
			private class SyncSortedList : TestCollection, IDictionary
		{
			private TestCollection list;
			private object root;
			...
			public override Test this[string key]
			{
				get
				{
					lock (root)
			...
			public override void Add(string key, Test value)
			{
				lock (root)
					list.Add(key, value);
			}
			...
			public override bool ContainsValue(Test value)
			{
				lock (root)
			...
			public override Test GetByIndex(int index)
			{
				lock (root)
			...
			public override int IndexOfValue(Test value)
			{
				lock (root)
			...
			public override void SetByIndex(int index, Test value)
			{
				lock (root)
			...
			private class ValueList : IList
		{
			...
			bool IList.Contains(object value)
			{
				...
				return list.ContainsValue((Test)value);
			}

			public virtual bool Contains(Test value)
			{
				return list.ContainsValue(value);
			}
			...
			object IList.this[int index]
			{
				...
				set
				{
					...
					list.SetByIndex(index, (Test)value);
				}
			}

			public virtual Test this[int index]
			{
				get
				{
					return list.GetByIndex(index);
			...
			int IList.IndexOf(object value)
			{
				...
				return list.IndexOfValue((Test)value);
			}

			public virtual int IndexOf(Test value)
			{
				return list.IndexOfValue(value);
			}
